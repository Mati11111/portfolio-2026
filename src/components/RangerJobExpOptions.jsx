...
export default function RangerJobExpOptions({ content }) {
  ...
  return (
    <div className="flex flex-row h-full">
      ...
      <section className="w-3/4 h-full border-l-2 ml-2 border-selected text-text-secondary  overflow-y-scroll">
