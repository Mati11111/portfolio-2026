...
export default function BarSectionContent({
  ...
  const [cantMoveAnimation, setCantMoveAnimation] = useState(false);
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-[90%] w-full gap-y-10">
      ...
      <section className="lg:flex lg:flex-col overflow-y-auto hidden flex-1 min-h-0">
        ...
        <div className="lg:flex hidden flex-row justify-around mt-5">
